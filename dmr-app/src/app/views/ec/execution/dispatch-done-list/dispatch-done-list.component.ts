...
@Component({
  selector: 'app-dispatch-done-list',
  templateUrl: './dispatch-done-list.component.html',
  styleUrls: ['./dispatch-done-list.component.css']
})
export class DispatchDoneListComponent implements OnInit {
