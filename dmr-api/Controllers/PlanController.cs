...
namespace DMR_API.Controllers
{
    ...
    public class PlanController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> ReportDoneList(ReportParams reportParams)
        {
            var lists = await _planService.ReportDoneList(reportParams);
            return Ok(lists);
        }

        [HttpPost]
        public async Task<IActionResult> ExportExcelDoneList(ReportParams reportParams)
        {
            var bin = await _planService.ExportExcelDoneList(reportParams);
